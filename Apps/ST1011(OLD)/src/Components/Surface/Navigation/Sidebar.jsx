import { Collapse, Divider, List, ListItem, ListItemIcon, ListItemText, Paper } from "@material-ui/core";
    ...
    <div>
      ...
      <List>
        ...
        {appPermissions ? (
          ...
          <ListItem>
            На вашем аккаунте нет привязаных приложений. Свяжитесь с пользователями высшей категории, или администрацией
            сайта для получения прав.
          </ListItem>
        )}
